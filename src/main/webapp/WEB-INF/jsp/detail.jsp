            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-xs-8 col-xs-offset-2">
                        <input type="text" id="killPhoneKey" name="killPhone" class="form-control" placeholder="填写手机号">
                    </div>
                </div>
            </div>
...
<script src="http://cdn.bootcss.com/jquery.countdown/2.1.0/jquery.countdown.min.js"></script><!--倒计时插件-->
